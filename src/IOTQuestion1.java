...
public class IOTQuestion1 {
    ...
    public static void createAndShowGUI() {
        totalQuestions = 10; // Total number of questions for IOT
        correctMarks = 5; // Correct marks per question

        frame = new JFrame("IOT Quiz - Question 1");
        ...
        JLabel questionLabel = new JLabel("Question: What is the primary goal of Internet of Things (IoT)?");
        ...
        JRadioButton option2 = new JRadioButton("B. Connect everyday devices to the internet to send and receive data");
    ...
    private static int calculateScore(int[] selectedOptions) {
        ...
        for (int option : selectedOptions) {
            if (option == 1) { // Correct option is B
                score += correctMarks;
                break;
            }
        }
