...
public class DBMSQuestion1 {
    ...
    public static void createAndShowGUI() {
        totalQuestions = 10; // Set the total number of questions for DBMS
        correctMarks = 5; // Set the correct marks per question

        frame = new JFrame("DBMS Quiz - Question 1");
        ...
        JLabel questionLabel = new JLabel("Question: What is DBMS?");
        ...
        JRadioButton option1 = new JRadioButton("A. Database Management System");
        JRadioButton option2 = new JRadioButton("B. Distributed Database Management System");
        JRadioButton option3 = new JRadioButton("C. Digital Database Management System");
        JRadioButton option4 = new JRadioButton("D. Dynamic Database Management System");
    ...
    private static int calculateScore(int[] selectedOptions) {
        ...
        for (int option : selectedOptions) {
            if (option == 0) { // Correct option is A
                score += correctMarks;
                break;
            }
        }
