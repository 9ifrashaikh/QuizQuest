...
public class DBMSQuestion2 {
    ...
    public static void createAndShowGUI() {
        totalQuestions = 10; // Total number of questions for DBMS
        correctMarks = 5; // Correct marks per question

        frame = new JFrame("DBMS Quiz - Question 2");
        ...
        JLabel questionLabel = new JLabel("Question: Which of the following is NOT a component of a DBMS?");
        ...
        JRadioButton option1 = new JRadioButton("A. Data");
        JRadioButton option2 = new JRadioButton("B. Hardware");
        JRadioButton option3 = new JRadioButton("C. Application program");
        JRadioButton option4 = new JRadioButton("D. Database schema (Correct)");
    ...
    private static int calculateScore(int[] selectedOptions) {
        ...
        for (int option : selectedOptions) {
            if (option == 3) { // Correct option is D
                score += correctMarks;
                break;
            }
        }
